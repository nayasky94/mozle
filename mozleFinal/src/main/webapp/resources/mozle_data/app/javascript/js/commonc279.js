...
// 함수부만 따로 호출
document.write('<script type="text/javascript" src="/mozle/resources/mozle_data/app/javascript/js/common-function.js?v=140729"></script>');
...
// 통계서버로 통계데이터 전달 - 사용중지... 각 쇼핑몰에서 처리함
...
/*    if($().jquery >= "1.7"){
        $.loadScript("/mozle/resources/mozle_data/app/javascript/plugin/jquery.jcryption.3.1.0_custom.js", function(){
            initJcryption();
        });
    }*/

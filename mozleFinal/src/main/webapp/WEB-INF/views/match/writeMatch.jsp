...
<script>
	...
	$(function(){
		$("#cancelBtn").click(function(){
			location.href="calendar.do?game=축구";
		});
		$("#searchField").click(function(){
			$("#searchFieldArea").css("display","block");
		});
	});
...
<div class="title" align="center">
	...
	<div class="formDiv">
	<h2>경기 등록</h2><hr>
	<form id="writeForm" action="/mozle/writeMatch.do" method="get">
	...
	<table>
		<tr>
			<td>경기일</td>
			<td>
				<input type="date" name="gDates" required>
		...
		<tr>
			...
			<td>경기비</td>
			<td colspan="3"><input type="number" name="pay" style="width:100%;" value="0" required></td>
		</tr>
		<tr>
			<td>경기 구장</td>
			<td colspan="3">
				<input type="text" name="field" id="field" style="width:85%;" readonly>
				<div id="searchField" onclick="searchField();">구장 검색</div>
			</td>
		</tr>
		<tr>
			<td>유니폼 색상</td>
			<td colspan="3"><input type="text" name="uColor" style="width:100%;" required></td>
		</tr>
		<tr>
			<td>내용 입력</td>
			<td colspan="3">
				<textarea id="content" cols="144" rows="4" name="content" style="resize: none;" required></textarea>
			</td>
		</tr>
	</table>
		<div align="center">

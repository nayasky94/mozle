...
<!-- 공지사항 작성 폼 본문 시작 -->
<div id="bbslist" style="margin-left:-250px; !important"><div><img src="http://eco-story.co.kr/data/skin/0727zerom/images/design/cs_tit_notice.gif" title="" alt="" /></div><br style="line-height:8px;" />



<form id="updateNotice" action="updateClubNotice.do" method="get">
	<input type="hidden" name="n_no" value="${notice.n_no }"/>
	<input type="hidden" name="n_clubname" value="${notice.n_clubname }"/>
	<input type="hidden" name="n_writer" value="${notice.n_writer }"/>
	<input type="hidden" name="n_date" value="${notice.n_date }"/>
	<input type="hidden" name="n_count" value="${notice.n_count }"/>
...
<table class="bbswrite_table_style"  width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<tr>
		<th class="cell">제목</th>
		<td class="cell" >
			<input type="text" name="n_title" id="subject" value="${notice.n_title }" class="required line"  title="제목을 입력해 주세요"  size="70" />
		</td>
	</tr>
	...
	<tr>
		...
		<td class="cell">
	<textarea id="summernote" name="n_content">${notice.n_content }</textarea>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="paging_navigation">
	...
	<td width="5%" align="center"><button name="writeNoticeBtn" class="bbs_btn" onclick="updateNotice.submit()">확인</button></td>
	<td width="5%" align="left"><button name="updateNoticeBtn" class="bbs_btn" onclick="location.href='ClubNoticeList.do?clubname=${notice.n_clubname}'">취소</button></td>

...
<div class="viewbox">
   ...
   <tr>
      ...
      <th class="right">
         <div class="right" >                        
            <button type="button" name="noticeListBtn" class="bbs_btn" onclick="location.href='ClubNoticeList.do?clubname=${notice.n_clubname}'">목록</button>
            <button type="button" name="noticeListBtn" class="bbs_btn" onclick="location.href='updateClubNoticeForm.do?no=${notice.n_no}'">수정</button>

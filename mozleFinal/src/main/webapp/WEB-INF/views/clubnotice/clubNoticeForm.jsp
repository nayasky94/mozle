...
<!-- 공지사항 작성 폼 본문 시작 -->
<div id="bbslist" style="margin-left:-230px; !important"><div><img src="http://eco-story.co.kr/data/skin/0727zerom/images/design/cs_tit_notice.gif" title="" alt="" /></div><br style="line-height:8px;" />



<form id="writeNotice" action="ClubWriteNotice.do" method="get">
...
<table class="bbswrite_table_style"  width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<input type="hidden" name="n_writer" value="${user.m_id }"/>
	<input type="hidden" name="n_clubname" value="${cname }"/>
</form>

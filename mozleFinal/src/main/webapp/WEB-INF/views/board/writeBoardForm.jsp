...
<form id="writeBoard" action="writeBoard.do" method="get">
...
<table class="bbswrite_table_style"  width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<tbody>
		...
		<td class="cell">
			<input style="width:130px;" type="text" name="b_writer" id="writer" value="${sessionScope.user.m_name }" class="required line" readonly="readonly"/>
...
<!-- 		</tr> -->
	...
	<tr>
		...
		<td class="cell" >
			...
			<input type="hidden" name="b_id" id="id" value="${sessionScope.user.m_id}"/>
		</td>
	</tr>
...
<div class="paging_navigation">
	...
	<td width="5%" align="left"><button name="updateNoticeBtn" class="bbs_btn" onclick="location.href='freeBoardList.do'">취소</button></td>

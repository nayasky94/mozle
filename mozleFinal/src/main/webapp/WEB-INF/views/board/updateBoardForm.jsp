...
<!-- 공지사항 작성 폼 본문 시작 -->
<div id="bbslist"><div><img src="/mozle/resources/mozle_data/data/boardimages/board.png" title="" alt="" /></div><br style="line-height:8px;" />



<form id="updateBoard" action="updateBoard.do" method="get">
	<input type="hidden" name="b_no" value="${board.b_no }"/>
	<input type="hidden" name="b_date" value="${board.b_date }"/>
	<input type="hidden" name="b_count" value="${board.b_count }"/>
...
<table class="bbswrite_table_style"  width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<tr>
		...
		<td class="cell">
			<input style="width:130px;" type="text" name="b_writer" id="b_writer" value="${board.b_writer }" class="required line" />
...
<!-- 		<td class="cell"> -->
<%-- 			<input style="width:130px;" type="password" value="${board.b_pwd }" name="b_pwd" id="pw" class="required line" /> --%>
...
<!-- 	</tr> -->
	...
	<tr>
		<th class="cell">제목</th>
		<td class="cell" >
			<input type="text" name="b_title" id="subject" value="${board.b_title }" class="required line"  title="제목을 입력해 주세요"  size="70" />
		</td>
	</tr>
...
<div class="paging_navigation">
	...
	<td width="5%" align="center"><button name="okBtn" class="bbs_btn" onclick="updateBoard.submit()">확인</button></td>
	<td width="5%" align="left"><button name="cancleBtn" class="bbs_btn" onclick="location.href='freeBoardList.do'">취소</button></td>

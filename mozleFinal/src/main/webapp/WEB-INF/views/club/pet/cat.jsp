...
body {
	...
	<div class="clearbox">
		...
		<div class="category_depth clearbox">
			...
			<li class='item' id='0001'>&gt; <a href='catalog?code=0001'>애완동물</a>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td align="left"><span class="sort_item"> 
				 <a href="cat.do"><b>고양이</b></a>
						&nbsp;&nbsp;|&nbsp;&nbsp; 	
					<a	href="dog.do">강아지</a>
						&nbsp;&nbsp;|&nbsp;&nbsp; 
					<a	href="fish.do">물고기</a>
				</span></td>
				<td align="right">
					<ul class="goods_list_style">
						<li class="lattice_a_on"><a
							href="?display_style=lattice_a&code=0001&popup=&iframe="
							title="격자형A"></a></li>
            ...
            <table class="goodsDisplayItemWrap" width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
               <tr>
                  <td align="center" width="314" height="314"  class="pro_thumb">   
                        ...
                        <img src=${list[i].c_thumbnail } width="314" />
                        </a>
                        </span>
                  </td>
               </tr>
            ...
            <table class="goodsDisplayItemWrap" width="100%"
               ...
               <tr>
                  <td align="center" width="314" height="314"
                     ...
                     version="20141110"> 
	                    <a href="/goods/view?no=11"   target="">
                        <img src=${list[i+1].c_thumbnail } width="314"  />
            ...
            <table class="goodsDisplayItemWrap"  width="100%"  align="center" cellpadding="0" cellspacing="0" border="0">
               <tr>
                  <td align="center" width="314" height="314"
                     ...
                     <a href="/goods/view?no=11"   target=""> 
                        <img src= ${list[i+2].c_thumbnail } width="314"  />
                     </a>
                  </span>
                  </td>
               </tr>

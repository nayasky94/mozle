				  ...
				  $.ajax({
				         ...
				         success:function(data){
				            if(data=='ok'){
				               ...
				               $("#id_info").text("클럽명 변경은 관리자에게 부탁하세요").css("color","red");
				            }
				         },
				      }); 
...
<form id="writeClubNotice" action="updateClubMain.do" method="post" enctype="multipart/form-data">
...
<table class="bbswrite_table_style"  width="100%" cellpadding="0" cellspacing="0" border="0" >
	...
	<tbody>
		...
		<td class="cell">
			<input style="width:130px;" type="text" name="c_name" id="c_name" value="${cm.c_name }" readonly	/>
			<span id="id_info">
...
<td></td>
		...
		<td class="cell">
			<input type="file"  name="file2" style="margin-left: 10px;" ></input>
	...
	<tr>
		...
		<td class="cell">
			<input type="file" name="file" style="margin-left: 10px;"></input>
	...
	<tr>
		...
		<td class="cell">
	<textarea id="summernote" name="c_content"> ${cm.c_content }</textarea>
		</td>
		<td></td>
	</tr>
	</tbody>

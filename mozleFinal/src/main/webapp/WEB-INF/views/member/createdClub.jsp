...
<tr><td><img src="/mozle/resources/mozle_data/myInfo/createClub.png" style="height:64px;""/></td></tr>
<tr><td height="10"></td></tr>
<tr><td><span class="desc">회원님이 만든 동호회를 확인 하실 수 있습니다.</span></td></tr>
</table>
<div style="height:30px;"></div>
<!-- List -->
<div style="height:8px;"></div>
<c:if test="${list.size() eq 0 }">
<a href="clubWriteForm.do"><input type="button" value="동호회 만들기" class="gray_btn" /></a>
</c:if>
<div style="height:8px;"></div>
...
<tr>
	<td>
		<table border="0">
				<c:if test="${list.size() eq 0 }">
				<tr>
				<td align="center">만든 동호회가 없습니다.</td>
				</tr>
				</c:if>

            ...
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-3">동호회에 가입된 회원 수</h4>
                                    <canvas id="clubMember"></canvas>
                                </div>
                            </div>
                        </div>
...
( function ( $ ) {
    ...
    var myChart = new Chart( ctx, {
        ...
        data: {
            ...
            datasets: [ {
                data: [ 20, 50, 25],
                label: "총 동호회 수",
                backgroundColor: 'rgba(0,215,250,0.1)',
                borderColor: 'rgba(0,190,250,0.5)',
                borderWidth: 3.5,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(0,190,250,0.5)',
                    }, ]
        },
        options: {
            responsive: true,
  ...
  //clubMember Count
    var ctx = document.getElementById( "clubMember" );
    ctx.height = 150;
    var myChart = new Chart( ctx, {
        type: 'line',
        data: {
            ...
            datasets: [ {
                data: [ 5, 7, 24],
                label: "동호회에 가입된 회원 수",
                backgroundColor: 'rgba(255,80,110,0.5)',
                borderColor: 'rgba(255,80,110,0.9)',
                borderWidth: 3.5,
                pointStyle: 'circle',
                pointRadius: 5,
                pointBorderColor: 'transparent',
                pointBackgroundColor: 'rgba(255,80,110,0.5)',
                    }, ]
        },
        options: {
            responsive: true,
